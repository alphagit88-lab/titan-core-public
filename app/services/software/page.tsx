...
import { Code2, ArrowRight, Layers, Cpu } from 'lucide-react';
          ...
          <div className="mx-auto max-w-7xl">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-6 font-[family:var(--font-space-grotesk)] text-5xl font-bold tracking-[-0.06em] text-[#0d1b2b] sm:text-7xl">
                Tailored Internal Workspaces.
              </h1>
              <p className="mt-8 text-xl leading-8 text-[#5b6778]">
                Replace manual spreadsheets and disconnected tools with custom software built to streamline your repetitive workflows and steady your operations.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: 'Turn repetitive manual tasks into automated background processes that save hundreds of hours.',
                  icon: Code2
                },
                {
                  title: 'Unified Data',
                  description: 'Connect your existing tools into a single source of truth for better operational awareness.',
                  icon: Layers
                },
                {
                  title: 'Scalable Architecture',
                  description: 'Systems built to grow with your team, ensuring long-term performance and maintainability.',
                  icon: Cpu
                }
              ].map((feature) => (
        ...
        <section className="bg-[#0d1b2b] px-4 py-24 text-white sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-white/70">
              Let's build the tools that will power your next phase of business growth.
            </p>
